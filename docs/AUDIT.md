...
| S3 | `index.html:33` vs `:49,55,63,71,77` | Canonical is `https://parth-tiwari.vercel.app` (**no trailing slash**); every JSON-LD `url`/`@id` and the sitemap use the trailing-slash form. Two different canonical identities. |
