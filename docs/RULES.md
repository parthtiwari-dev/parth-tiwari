...
(`02b5669`) on the owner's direction on 2026-09-23 and pushed the same day. Any later push
deploys to production and needs the owner's explicit go. The `redesign/v2` instruction below
